...
namespace Demo
{
    class PlayState : FlxState
    {
        ...
        public override void Initialize()
        {
            ...
            _scoreDisplay.Alignment = TextAlign.CENTER;
            ...
            _highScore.Alignment = TextAlign.CENTER;
        ...
        {
            if (Reg.SaveFile.HighScore >= Reg.Score)
                return;
            Reg.SaveFile.HighScore = Reg.Score;
            Reg.Save.WriteToFile(FileFormats.Xml, Reg.SaveFile);
        ...
        public static int LoadScore()
        {
            ...
            {
                Reg.SaveFile = Reg.Save.ReadFromFile<SaveFile>(FileFormats.Xml);
            }
